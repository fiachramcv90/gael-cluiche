...
function generateQuestion(): GameQuestion {
  // Keep it simple: larger number minus smaller, result always positive
  // num1 between 3-10, num2 between 1 and (num1-1)
  ...
  while (wrongAnswers.size < 3) {
    ...
    if (wrongAnswer !== answer && wrongAnswer >= 0 && wrongAnswer <= 10) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] p-4">
      ...
      <p className="mt-8 text-white/50 text-center text-sm">
        Bain an dara huimhir ón gcéad uimhir
      </p>
    </div>
  )
}
